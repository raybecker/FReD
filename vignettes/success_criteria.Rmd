...
```{r}
assess_replication_outcome(es_o = .5, n_o = 50, es_r = .1, n_r = 1000, criterion = "significance_r")
```
...
```{r}
assess_replication_outcome(es_o = .5, n_o = 50, es_r = .1, n_r = 50, criterion = "significance_agg")
```
...
```{r}
assess_replication_outcome(es_o = .5, n_o = 50, es_r = .3, n_r = 50, criterion = "consistency_ci")
assess_replication_outcome(es_o = .5, n_o = 50, es_r = .4, n_r = 500, criterion = "consistency_ci")
```
...
```{r}
assess_replication_outcome(es_o = .5, n_o = 50, es_r = .3, n_r = 500, criterion = "consistency_pi")
```
...
```{r}
assess_replication_outcome(es_o = .2, n_o = 100, es_r = 0, n_r = 500, criterion = "homogeneity")
```
...
```{r}
assess_replication_outcome(es_o = .2, n_o = 100, es_r = 0, n_r = 500, criterion = "homogeneity_significance")
```
...
```{r}
assess_replication_outcome(es_o = .5, n_o = 50, es_r = .2, n_r = 100, criterion = "small_telescopes")
assess_replication_outcome(es_o = .5, n_o = 30, es_r = .2, n_r = 100, criterion = "small_telescopes")
```
